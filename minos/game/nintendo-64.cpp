auto Game::n64_romInternalName() -> string {
  ...
  //Shift JIS is dangerous to use for filenames; only older 日本ese
  ...
  //Most 日本ese games that do not use ASCII use halfwidth ｶﾀｶﾅ, which
  ...
  return name;  //ramus::convertShiftJIStoUTF8(name);
}
